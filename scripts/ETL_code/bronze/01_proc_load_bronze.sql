...
==========================================
Script Purpose:
	This script is used to load data from source to tables in the bronze schema
	It performs the following actions (- BULK INSERT script for all tables)
...
Parameters:
	None, this Stored procedure doesnt accept any parameters
