...
-------------------------------------------------------
Script Purpose:
		- This script purpose is to populate the tables in schema 'silver' from tables 
			in schema 'bronze'

Actions Performed:
		- Truncating the table in silver layer
		- Ingesting data into tables in schema 'silver'
